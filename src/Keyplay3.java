...
public class Keyplay3 extends ImageIcon {
	...
	public Keyplay3(URL imgURL, int x, int y, int margin, int steps, int xBoundary, int yBoundary) {
		// imgPath : 그림 파일의 경로명
		// x, y : 이미지의 시작 위치 좌표
	...
	public Keyplay3(URL imgURL, int margin, int steps, int xBoundary, int yBoundary) {
	...
	public Keyplay3(URL imgURL, int margin, int xBoundary, int yBoundary) {
